...
export class ApiService {
  ...
  getPatients(): Observable<any> {
    return this.http.get<any>('http://localhost:4000/api/patient/get');
  }

  addPatient(data: any): Observable<any> {
    return this.http.post<any>('http://localhost:4000/api/patient/add', data);
  }
  ...
  getAppointments(): Observable<any> {
    return this.http.get<any>('http://localhost:4000/api/appointment/get');
  }
